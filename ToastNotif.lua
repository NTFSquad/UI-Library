local Services = loadstring(game:HttpGet("https://raw.githubusercontent.com/ModerkaScripts/Aztup-Hub-V3/master/files/utils/Services.lua"))();
local Maid = loadstring(game:HttpGet("https://raw.githubusercontent.com/ModerkaScripts/Aztup-Hub-V3/master/files/utils/Maid.lua"))();
local Signal = loadstring(game:HttpGet("https://raw.githubusercontent.com/ModerkaScripts/Aztup-Hub-V3/master/files/utils/Signal.lua"))();
